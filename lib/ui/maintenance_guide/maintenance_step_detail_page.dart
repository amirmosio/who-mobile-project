...
class MaintenanceStepDetailPage extends ConsumerWidget {
  final String stepId;

  const MaintenanceStepDetailPage({super.key, required this.stepId});
      ...
      body: maintenanceDataAsync.when(
        ...
        data: (maintenanceData) {
          final step = maintenanceData.sections.firstWhere(
            ...
            orElse: () => MaintenanceStepModel(id: '', title: 'Not Found'),
          );
