...
class DismantlingStepItem extends StatelessWidget {
  final DismantlingStepModel section;
  final int index;
  final bool isExpanded;
  final int completedSubsteps;
  final List<FlattenedDismantlingSubstepModel> sectionSubsteps;
  final int lastCompletedIndex;
  final VoidCallback onExpandToggle;

  const DismantlingStepItem({
    super.key,
      ...
      child: Column(
        children: [
          InkWell(
            onTap: () {
              context.push(
                YRRoutes.dismantlingStepDetail.replaceFirst(
                  ':stepId',
                  section.id,
                ),
              );
