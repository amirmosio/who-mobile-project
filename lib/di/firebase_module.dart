...
abstract class FirebaseModule {
  ...
  /// Provides FirebaseCommentsService as a singleton
  /// The service handles all Firestore operations for comments
  @singleton
  FirebaseCommentsService get firebaseCommentsService =>
      FirebaseCommentsService();

  /// Provides CommentsRepository
  /// Repository wraps the service with error handling and returns RepositoryState
  @injectable
  CommentsRepository commentsRepository(
    FirebaseCommentsService commentsService,
  ) =>
